...
class LIME:
    ...
    def explain_all(self, model, data, device):
        ...
        with open('./result/lime/lime_explain_new.csv','w', newline='') as f:
    ...
    def explain_random(self, model, data, device, explain_num=100):
        ...
        with open('./result/lime/lime_explain_new.csv','a', newline='') as f:
            writer = csv.DictWriter(f, fieldnames=fieldnames)
    ...
    def explain_top(self, model, data, device, explain_num=100):
        ...
        with open('./result/lime/lime_explain_new.csv','a', newline='') as f:
            ...
            spot_top_idx = np.load('./data/spot/top_spot_idx.npy')[:200]
            print(spot_top_idx)
...
if __name__=='__main__':
    ...
    lime.explain_random(model, data, device=device, explain_num=100)
